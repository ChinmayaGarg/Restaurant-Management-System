...
var permission_keys_1 = require("../../../../packages/permissions/permission-keys");
// import { PERMISSIONS } from "@restaurant-platform/permissions";
var prisma = new client_1.PrismaClient();
function getModuleFromKey(key) {
    var _a;
    return (_a = key.split(".")[0]) !== null && _a !== void 0 ? _a : "general";
}
function seedPermissions() {
    return __awaiter(this, void 0, void 0, function () {
        var values, _i, values_1, key;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    values = Object.values(permission_keys_1.PERMISSIONS);
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    console.log("Seeded ".concat(values.length, " permissions"));
                    return [2 /*return*/];
            }
        });
    });
