...
function seedMenu(branchId) {
    return __awaiter(this, void 0, void 0, function () {
        var categories, c, category, _i, _a, item;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _b.label = 1;
                case 1:
                    if (!(c < categories.length)) return [3 /*break*/, 7];
                    return [4 /*yield*/, prisma.menuCategory.upsert({
                            where: {
                                branchId_name: {
                                    branchId: branchId,
